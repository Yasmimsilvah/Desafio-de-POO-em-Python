...
goblin_1 = Monstro.criar_goblin_padrao("Goblin Fedorento")
goblin_2 = Monstro.criar_goblin_padrao("Goblin Ladrão")

print(f"Monstro 1: {goblin_1.nome}, Vida: {goblin_1.get_vida()}, Força: {goblin_1.forca_base}")
print(f"Monstro 2: {goblin_2.nome}, Vida: {goblin_2.get_vida()}, Força: {goblin_2.forca_base}")