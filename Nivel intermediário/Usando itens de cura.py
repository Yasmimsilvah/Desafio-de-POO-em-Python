...
guerreiro = Guerreiro("Conan", 100, 15, 5)
pocao_media = Pocao("Poção Média", 30)

guerreiro.inventario.adicionar_item(pocao_media)
guerreiro.receber_dano(40)
guerreiro.usar_item(pocao_media)

pocao_grande = Pocao("Poção Grande", 50)
guerreiro.inventario.adicionar_item(pocao_grande)
guerreiro.usar_item(pocao_grande) 