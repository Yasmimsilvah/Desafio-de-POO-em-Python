...
class Personagem:
    ...
    def atacar(self, alvo):
        dano_dado = Dado.rolar(4) 
        dano_total = self.forca_base + dano_dado
        print(f"\n{self.nome} ataca {alvo.nome} (Dano Base: {self.forca_base} + D4: {dano_dado}) causando {dano_total} de dano!")
...
guerreiro = Personagem("Heroi Teste", 100, 10)
goblin = Monstro.criar_goblin_padrao("Inimigo Sortudo")
